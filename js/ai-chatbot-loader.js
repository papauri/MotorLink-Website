        ...
        <div class="ai-car-chat-widget" id="aiCarChatWidget">
            <div class="ai-chat-header" id="aiChatHeader">
                ...
                <div class="ai-chat-header-actions">
                    <button class="ai-chat-header-btn" id="aiChatMinimizeBtn" title="Minimize" aria-label="Minimize chat">
                        <i class="fas fa-minus"></i>
                    </button>
                    <button class="ai-chat-header-btn ai-chat-header-close" id="aiChatCloseBtn" title="Close AI Chat" aria-label="Close AI chat">
            ...
            <button class="ai-chat-minimized" id="aiChatMinimized" aria-label="Open AI chat">
                <span class="ai-min-icon"><i class="fas fa-comments"></i></span>
            </button>
